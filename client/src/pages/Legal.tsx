...
const documents: Record<string, Document> = {
  privacy: {
    ...
    notice: "هذه صياغة تشغيلية مخصصة للمنصة وليست بديلاً عن مراجعة محامٍ مرخّص يحدد القانون الواجب التطبيق والجهة القانونية المشغّلة قبل الإطلاق التجاري.",
    sections: [
  ...
  contact: {
    ...
    sections: [
      ...
      { heading: "قنوات التواصل المعلنة", body: "تظهر روابط التواصل الاجتماعي الرسمية في أسفل الموقع عندما يضيفها مدير النظام ويعتمدها. لا تعتمد على حسابات تنتحل اسم المنصة، وتحقق من الرابط الظاهر في فوتر الموقع قبل مشاركة معلوماتك." },
    ],
  },
};
